...
<script>
    Joomla.submitbutton = function (task) {
        ...
        if (task === 'companies.download') {
            location.href = 'index.php?option=com_reports&task=companies.execute&format=xls';
            return false;
        }
...
<div class="row-fluid">
    ...
    <div id="j-main-container" class="span10">
        <form action="<?php echo ReportsHelper::getActionUrl(); ?>" method="post"
            ...
            <?php echo JText::sprintf(!is_numeric(PrjHelper::getActiveProject()) ? 'COM_REPORTS_MSG_PROJECT_IS_NOT_SELECTED' : 'COM_REPORTS_MSG_DATA_IS_LOAD');?>
