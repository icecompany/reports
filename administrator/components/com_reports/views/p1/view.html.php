...
class ReportsViewP1 extends HtmlView
{
    protected $sidebar = '';
    ...
    {
        JToolBarHelper::title(JText::sprintf('COM_REPORTS_MENU_QUARTER_P1'), 'list-2');
        JToolbarHelper::custom('p1.download', 'download', 'download', JText::sprintf('COM_MKV_BUTTON_EXPORT_TO_EXCEL'), false);
